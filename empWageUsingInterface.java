...
public class empWageUsingInterface implements EmpComputeWage {
        ...
        @Override
        //method to caculate total wages
        public int getWagesByCompanyName(String name){
                int totalWage = 0;
                //loop through list of companies using for loop
	...
	@Override
        ...
        public static void main(String[] args) {
                ...
                EmpComputeWage ebi = new empWageUsingInterface();
                ...
                int totalWages1 = ebi.getWagesByCompanyName("JioMart");
